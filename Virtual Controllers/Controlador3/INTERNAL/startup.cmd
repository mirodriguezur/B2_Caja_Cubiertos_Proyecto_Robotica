...
# Add pgmrun info to system dump service
sysdmp_add -show pgmrun_spy_show -source pgmrun_spy
...
goto -label NEXT_STEP
#LOAD_CMD
delete -path $RWTEMP/post_startup_action.cmd
rename -from $INTERNAL/post_startup_action.cmd -to $RWTEMP/post_startup_action.cmd
include -path $RWTEMP/post_startup_action.cmd
#NEXT_STEP
